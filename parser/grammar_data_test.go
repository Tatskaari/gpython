...
var grammarTestData = []struct {
	...
	{"0", "eval", "Expression(body=Constant(value=0, kind=None))", nil, ""},
	{"0000", "eval", "Expression(body=Constant(value=0, kind=None))", nil, ""},
	{"0_000", "eval", "Expression(body=Constant(value=0, kind=None))", nil, ""},
	{"1234", "eval", "Expression(body=Constant(value=1234, kind=None))", nil, ""},
	{"1_234", "eval", "Expression(body=Constant(value=1234, kind=None))", nil, ""},
	{"1__234", "eval", "", py.SyntaxError, "illegal decimal literal"},
	{"1_234_", "eval", "", py.SyntaxError, "illegal decimal literal"},
	{"79228162514264337593543950336", "eval", "Expression(body=Constant(value=79228162514264337593543950336, kind=None))", nil, ""},
	{"01234", "eval", "", py.SyntaxError, "illegal decimal with leading zero"},
	{"1234d", "eval", "", py.SyntaxError, "invalid syntax"},
	{"1234j", "eval", "Expression(body=Constant(value=1234j, kind=None))", nil, ""},
	{"-1234j", "eval", "Expression(body=UnaryOp(op=USub(), operand=Constant(value=1234j, kind=None)))", nil, ""},
	{"123.4j", "eval", "Expression(body=Constant(value=123.4j, kind=None))", nil, ""},
	{"-123.4j", "eval", "Expression(body=UnaryOp(op=USub(), operand=Constant(value=123.4j, kind=None)))", nil, ""},
	...
	{"0x12_34", "eval", "Expression(body=Constant(value=4660, kind=None))", nil, ""},
	{"0xdead_beef", "eval", "Expression(body=Constant(value=3735928559, kind=None))", nil, ""},
	{"0o1234", "eval", "Expression(body=Constant(value=668, kind=None))", nil, ""},
	{"0o12_34", "eval", "Expression(body=Constant(value=668, kind=None))", nil, ""},
	{"0b0110_1100", "eval", "Expression(body=Constant(value=108, kind=None))", nil, ""},
	{"0b_1110_0101", "eval", "Expression(body=Constant(value=229, kind=None))", nil, ""},
	{"12.34", "eval", "Expression(body=Constant(value=12.34, kind=None))", nil, ""},
	{"1_234.50", "eval", "Expression(body=Constant(value=1234.5, kind=None))", nil, ""},
	{"1__234.50", "eval", "", py.SyntaxError, "illegal decimal literal"},
	{"1_234.50_", "eval", "", py.SyntaxError, "illegal decimal literal"},
	...
	{"a(*b,c=d,*e,**f)", "eval", "Expression(body=Call(func=Name(id='a', ctx=Load()), args=[Starred(value=Name(id='b', ctx=Load()), ctx=Load()), Starred(value=Name(id='e', ctx=Load()), ctx=Load())], keywords=[keyword(arg='c', value=Name(id='d', ctx=Load())), keyword(arg=None, value=Name(id='f', ctx=Load()))]))", nil, ""},
	{"a(b=c,*d,**e)", "eval", "Expression(body=Call(func=Name(id='a', ctx=Load()), args=[Starred(value=Name(id='d', ctx=Load()), ctx=Load())], keywords=[keyword(arg='b', value=Name(id='c', ctx=Load())), keyword(arg=None, value=Name(id='e', ctx=Load()))]))", nil, ""},
	...
	{"a(*b,c,**d,x=e,**f,g=h)", "eval", "Expression(body=Call(func=Name(id='a', ctx=Load()), args=[Starred(value=Name(id='b', ctx=Load()), ctx=Load()), Name(id='c', ctx=Load())], keywords=[keyword(arg=None, value=Name(id='d', ctx=Load())), keyword(arg='x', value=Name(id='e', ctx=Load())), keyword(arg=None, value=Name(id='f', ctx=Load())), keyword(arg='g', value=Name(id='h', ctx=Load()))]))", nil, ""},
	...
	{"async for a, b in b:\n pass\nelse: break\n", "exec", "Module(body=[AsyncFor(target=Tuple(elts=[Name(id='a', ctx=Store()), Name(id='b', ctx=Store())], ctx=Store()), iter=Name(id='b', ctx=Load()), body=[Pass()], orelse=[Break()], type_comment=None)], type_ignores=[])", nil, ""},
	...
	{"async with x as y:\n    pass\n", "exec", "Module(body=[AsyncWith(items=[withitem(context_expr=Name(id='x', ctx=Load()), optional_vars=Name(id='y', ctx=Store()))], body=[Pass()], type_comment=None)], type_ignores=[])", nil, ""},
	...
	{"a: int = b", "exec", "Module(body=[AnnAssign(target=Name(id='a', ctx=Store()), annotation=Name(id='int', ctx=Load()), value=Name(id='b', ctx=Load()), simple=1)], type_ignores=[])", nil, ""},
	{"a = await b", "exec", "Module(body=[Assign(targets=[Name(id='a', ctx=Store())], value=Await(value=Name(id='b', ctx=Load())), type_comment=None)], type_ignores=[])", nil, ""},
	...
	{"async def fn(): pass", "exec", "Module(body=[AsyncFunctionDef(name='fn', args=arguments(posonlyargs=[], args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Pass()], decorator_list=[], returns=None, type_comment=None)], type_ignores=[])", nil, ""},
	...
	{"def fn(a: int, /, *, c: float=d, **kws) -> None: pass", "exec", "Module(body=[FunctionDef(name='fn', args=arguments(posonlyargs=[arg(arg='a', annotation=Name(id='int', ctx=Load()), type_comment=None)], args=[], vararg=None, kwonlyargs=[arg(arg='c', annotation=Name(id='float', ctx=Load()), type_comment=None)], kw_defaults=[Name(id='d', ctx=Load())], kwarg=arg(arg='kws', annotation=None, type_comment=None), defaults=[]), body=[Pass()], decorator_list=[], returns=Constant(value=None, kind=None), type_comment=None)], type_ignores=[])", nil, ""},
	...
	{"class A(B,C,D=F,*AS,**KWS):\n    a: int\n    b: float = 4\n", "exec", "Module(body=[ClassDef(name='A', bases=[Name(id='B', ctx=Load()), Name(id='C', ctx=Load()), Starred(value=Name(id='AS', ctx=Load()), ctx=Load())], keywords=[keyword(arg='D', value=Name(id='F', ctx=Load())), keyword(arg=None, value=Name(id='KWS', ctx=Load()))], body=[AnnAssign(target=Name(id='a', ctx=Store()), annotation=Name(id='int', ctx=Load()), value=None, simple=1), AnnAssign(target=Name(id='b', ctx=Store()), annotation=Name(id='float', ctx=Load()), value=Constant(value=4, kind=None), simple=1)], decorator_list=[])], type_ignores=[])", nil, ""},
	...
	{"@dec\nasync def fn():\n    pass\n", "exec", "Module(body=[AsyncFunctionDef(name='fn', args=arguments(posonlyargs=[], args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Pass()], decorator_list=[Name(id='dec', ctx=Load())], returns=None, type_comment=None)], type_ignores=[])", nil, ""},
