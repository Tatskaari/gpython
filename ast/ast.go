...
type Module struct {
	...
	Type_ignores []struct{} // Unused, but here to make dump output consistent with cpython.
}
...
type FunctionDef struct {
	...
	DecoratorList []Expr
	Returns       Expr
	Type_comment  interface{} // Unused, but here to make dump output consistent with cpython.
}
