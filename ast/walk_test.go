...
func TestWalk(t *testing.T) {
	...
	for _, test := range []struct {
		...
		// Exercise the walk* closures
		{&Module{Body: []Stmt{&Pass{}}}, []string{"*ast.Module", "*ast.Pass"}},
		{&Module{Body: []Stmt{&Pass{}, &Pass{}}}, []string{"*ast.Module", "*ast.Pass", "*ast.Pass"}},
		{&Expression{Body: &Constant{}}, []string{"*ast.Expression", "*ast.Constant"}},
		{&Attribute{Value: &Constant{}}, []string{"*ast.Attribute", "*ast.Constant"}},
		{
			&List{Elts: []Expr{&Constant{}, &Constant{}}},
			[]string{"*ast.List", "*ast.Constant", "*ast.Constant"},
		},
		{
			&ListComp{
				Elt: &Constant{},
				Generators: []Comprehension{
					{Target: &Constant{}, Iter: &Constant{}, Ifs: []Expr{&Constant{}, &Constant{}}},
				},
			},
			[]string{
				"*ast.ListComp",
				"*ast.Constant", "*ast.Constant", "*ast.Constant", "*ast.Constant", "*ast.Constant",
			},
		},
	} {
		out = nil
